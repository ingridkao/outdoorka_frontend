      ...
      <Grid container justifyContent="center">
        ...
        >
          ...
          <Box sx={cardStyle.box}>
            ...
            <Typography variant="body1" sx={bodyStyle}>
              <b>成為主揪，策劃你的專屬活動！</b>
              在這裡，你可以發起徒步、登山、衝浪、露營等各類活動，招募志同道合的夥伴一起探險。無論是單日行程還是多日挑戰，你的創意都能在這裡大放異彩！
            </Typography>
            <Typography variant="body1" sx={bodyStyle}>
              <b>跟團仔們，準備好一起出發吧！</b>
              瀏覽我們的活動列表，選擇心儀的活動報名參加。結識新朋友、體驗新挑戰，每一次出行都將是難忘的回憶。我們的活動涵蓋了各種難度和類型，讓你輕鬆找到適合自己的冒險之旅。
            </Typography>
            <Typography variant="h4" sx={h4Style}>
              為什麼選擇我們？
            </Typography>
            <Typography variant="body1" sx={bodyStyle}>
              <b>豐富多樣的活動</b>
              ：從海灘到山巔，從城市到荒野，我們的活動覆蓋各種地形和場景，滿足你對戶外的所有想像。
            </Typography>
            <Typography variant="body1" sx={bodyStyle}>
              <b>活力社群</b>
              ：加入我們，你將成為這個充滿活力和陽光的社群一員，與大家一起分享戶外的樂趣和經驗。
            </Typography>
            <Typography variant="body1" sx={bodyStyle}>
              <b>個性化推薦</b>
              ：根據你的興趣和活動偏好，我們為你推薦最適合的活動，讓每一次出行都更加精彩。
            </Typography>
            <br />
            <Typography variant="h4" sx={h4Style}>
